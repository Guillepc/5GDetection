function [waveformsAll, resourceGrids, ssbTimes, powerVec, snrVec, cellIDVec] = MonitoreoContinuoAmpli
  clear; clc; 
  ...
  %  Configuración SDR, banda y parámetros 
    ...
    GSCN = 7880; % Índice que referencia una frecuencia particular dentro del rango 5G NR para esa banda
    ...
    monitorTime = 2; % Tiempo en el que se va a capturar señales
    interval = 0.1;  % Intervalo entre capturas 
    framesPerCapture = 4; % Número de frames por captura. Cada frame corresponde a una duración en tiempo estándar de un frame 5G NR (generalmente 10 ms por frame).
